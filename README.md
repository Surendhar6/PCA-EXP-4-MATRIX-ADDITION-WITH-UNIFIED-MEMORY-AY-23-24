...
## OUTPUT:
### WITH MEMSET() 
![image](https://github.com/user-attachments/assets/71996f5c-6316-4cdb-82ec-689b3a1c8425)

### WITHOUT MEMSET()
![image](https://github.com/user-attachments/assets/5d318e8f-4480-4207-af11-3ed8445d85ea)

## RESULT:
Thus the program has been executed by using unified memory. It is observed that removing memset function has given less/more 0.046242 time.
